...
import { Mail, Lock, Eye, EyeOff, FileText, CheckCircle2, User } from 'lucide-react';
...
const Register = () => {
  ...
  // Password rules validation logic for UI checkboxes
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1e3a8a] to-[#3b82f6] p-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-[400px] w-full z-10 my-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                name="name"
                className={`w-full pl-10 pr-3 py-2.5 bg-white border ${errors.name ? 'border-red-400 focus:ring-red-400' : 'border-gray-200 focus:ring-blue-600 focus:border-blue-600'} rounded-lg focus:outline-none focus:ring-1 transition-all text-sm text-gray-800`}
          ...
          <div>
            ...
            {/* Password Rules */}
            <div className="flex items-center gap-3 mt-3 text-[11px] text-gray-500 font-medium justify-between px-1">
              <div className="flex items-center gap-1.5">
                <CheckCircle2 size={13} className={passwordRules.length ? "text-blue-600" : "text-gray-300"} />
                <span className={passwordRules.length ? "text-gray-700" : ""}>Min 8 characters</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 size={13} className={passwordRules.number ? "text-blue-600" : "text-gray-300"} />
                <span className={passwordRules.number ? "text-gray-700" : ""}>One number</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 size={13} className={passwordRules.uppercase ? "text-blue-600" : "text-gray-300"} />
                <span className={passwordRules.uppercase ? "text-gray-700" : ""}>One uppercase letter</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-10 py-2.5 bg-white border ${errors.confirmPassword ? 'border-red-400 focus:ring-red-400' : 'border-gray-200 focus:ring-blue-600 focus:border-blue-600'} rounded-lg focus:outline-none focus:ring-1 transition-all text-sm text-gray-800`}
